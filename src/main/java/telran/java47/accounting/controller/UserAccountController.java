...
public class UserAccountController {
	...
	public RolesDto addRole(@PathVariable String role, @PathVariable String login) {
		return userAccountService.changeRolesList(login, role, true);
	}
	
	
	@DeleteMapping("/user/{login}/role/{role}")
	public RolesDto deleteRole(@PathVariable String role, @PathVariable String login) {
